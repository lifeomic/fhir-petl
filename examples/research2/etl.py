...
index = patients.cut("SID", "id", "sample_date").rename("id", "subject")
...
procedures = (
    ...
    .fieldmap(
        {
            "id": "ID",
            "date": lambda rec: date(
                rec["PROC_DATE"] or rec["ARRIVE_DATE"] or rec["DISCHARGE_DATE"]
            ),
            "code": proc_code,
            "subject": "subject",
            "note": "ENC_TYPE",
...
observations = (
    ...
    .fieldmap(
        {
            "id": "ID",
            "date": lambda rec: rec["sample_date"]
            + timedelta(int(rec["Date_VIS_Sample"])),
            "code": cv_code,
            "value": cv_value,
            "subject": "subject",
        },
    ...
    .fieldmap(
        {
            ...
            "status": (
                "FILL_COMPLETE",
                lambda complete: "completed" if complete == "1" else None,
            ),
        },
        True,
    )
